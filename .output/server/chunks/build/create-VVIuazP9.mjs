...
import { _ as _sfc_main$p } from './LandingLogo-CaslIrmP.mjs';
import { _ as __nuxt_component_0$4 } from './nuxt-link-CCbinDlN.mjs';
import { defineComponent, mergeProps, toRefs, reactive, watch, computed, unref, withCtx, createTextVNode, toDisplayString, createVNode, withDirectives, vModelText, createBlock, openBlock, ref, createCommentVNode, Fragment, vModelCheckbox, withModifiers, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderClass, ssrRenderAttr, ssrIncludeBooleanAttr, ssrLooseEqual, ssrRenderStyle, ssrRenderSlot, ssrRenderSlotInner, ssrLooseContain } from 'vue/server-renderer';
import { k as useRoute, g as useI18n, u as useHead, _ as _export_sfc, d as useRuntimeConfig, i as useSwitchLocalePath } from './server.mjs';
...
const _imports_0 = "" + buildAssetsURL("sprite.DSFI2w_c.svg");
...
const _sfc_main$j = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const editor = useEditor({
      ...
      onUpdate: () => {
        var _a;
        emit("update:modelValue", (_a = editor.value) == null ? void 0 : _a.getHTML());
      }
    });
    watch(
      () => props.modelValue,
      (value) => {
        var _a, _b;
        const isSame = ((_a = editor.value) == null ? void 0 : _a.getHTML()) === value;
        if (isSame)
          return;
            ...
            content: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                if (__props.sectionName === "projects") {
                  ...
                  _push2(`<!--[--> \u{1F4CD} ${ssrInterpolate(_ctx.$t("location"))}<!--]-->`);
                }
                _push2(`</label><input${ssrRenderAttr("id", `entryLocation-${entry.id}`)}${ssrRenderAttr("value", entry.location)} class="form__control" type="text" data-v-96b9866f${_scopeId}></div><div class="form__group col-span-full" data-v-96b9866f${_scopeId}><div class="form__label flex justify-between" data-v-96b9866f${_scopeId}><label${ssrRenderAttr("for", `entryFrom-${entry.id}`)} data-v-96b9866f${_scopeId}> \u{1F4C6} ${ssrInterpolate(_ctx.$t("from"))}</label>`);
                ...
                _push2(`</div><div class="form__group col-span-full" data-v-96b9866f${_scopeId}><label class="form__label"${ssrRenderAttr("for", `entrySummary-${entry.id}`)} data-v-96b9866f${_scopeId}>\u{1F4DD} ${ssrInterpolate(_ctx.$t("summary"))}</label>`);
                  ...
                  createVNode("div", { class: "dynamic-section" }, [
                    ...
                    createVNode("div", { class: "form__group col-span-full" }, [
                      createVNode("label", {
                        ...
                        __props.sectionName === "projects" ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                          createTextVNode(" \u{1F517} Link ")
                        ], 64)) : (openBlock(), createBlock(Fragment, { key: 1 }, [
                          createTextVNode(" \u{1F4CD} " + toDisplayString(_ctx.$t("location")), 1)
                        ], 64))
                      ], 8, ["for"]),
                      withDirectives(createVNode("input", {
                    ...
                    createVNode("div", { class: "form__group col-span-full" }, [
                      createVNode("div", { class: "form__label flex justify-between" }, [
                        ...
                        }, " \u{1F4C6} " + toDisplayString(_ctx.$t("from")), 9, ["for"]),
                    ...
                    createVNode("div", { class: "form__group col-span-full" }, [
                      createVNode("label", {
                        ...
                        createTextVNode(" \u{1F4C6} " + toDisplayString(_ctx.$t("to")) + " ", 1),
                    ...
                    createVNode("div", { class: "form__group col-span-full" }, [
                      ...
                      }, "\u{1F4DD} " + toDisplayString(_ctx.$t("summary")), 9, ["for", "onClick"]),
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_expansion_panel, {
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="grid grid-cols-2 gap-x-3 gap-y-10" data-v-05de4b4b${_scopeId}><div class="form__group col-span-full" data-v-05de4b4b${_scopeId}><span class="form__label" data-v-05de4b4b${_scopeId}>\u{1F4F7} ${ssrInterpolate(_ctx.$t("profile-image"))}</span>`);
              ...
              createVNode("div", { class: "grid grid-cols-2 gap-x-3 gap-y-10" }, [
                ...
                createVNode("div", { class: "form__group col-span-full" }, [
                  createVNode("label", {
                    class: "form__label",
                    for: "job-pos"
                  }, "\u{1F4BC} " + toDisplayString(_ctx.$t("job-title")), 1),
                  withDirectives(createVNode("input", {
                    id: "job-pos",
                ...
                createVNode("div", { class: "form__group" }, [
                  createVNode("label", {
                    class: "form__label",
                    for: "first-name"
                  }, "\u{1F464} " + toDisplayString(_ctx.$t("first-name")), 1),
                  withDirectives(createVNode("input", {
                    id: "first-name",
                ...
                createVNode("div", { class: "form__group" }, [
                  createVNode("label", {
                    class: "form__label",
                    for: "last-name"
                  }, "\u{1F464} " + toDisplayString(_ctx.$t("last-name")), 1),
                  withDirectives(createVNode("input", {
                    id: "last-name",
                ...
                createVNode("div", { class: "form__group" }, [
                  createVNode("label", {
                    class: "form__label",
                    for: "location"
                  }, "\u{1F4CD} " + toDisplayString(_ctx.$t("location")), 1),
                  withDirectives(createVNode("input", {
                    id: "location",
                ...
                createVNode("div", { class: "form__group" }, [
                  createVNode("label", {
                    class: "form__label",
                    for: "phone"
                  }, "\u{1F4F1} " + toDisplayString(_ctx.$t("phone-number")), 1),
                  withDirectives(createVNode("input", {
                    id: "phone",
                ...
                createVNode("div", { class: "form__group col-span-full" }, [
                  createVNode("label", {
                    class: "form__label",
                    for: "aboutme"
                  }, "\u{1F31F} " + toDisplayString(_ctx.$t("about-me")), 1),
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_CvInputTags, {
              ...
              "tag-list-label": `\u{1F6E0} ${_ctx.$t("technical-skills")}`,
            ...
            _push2(ssrRenderComponent(_component_CvInputTags, {
              ...
              "tag-list-label": `\u{1F9F8} ${_ctx.$t("soft-skills")}`,
            ...
            _push2(ssrRenderComponent(_component_CvInputTags, {
              ...
              "tag-list-label": `\u{1F30E} ${_ctx.$t("languages")}`,
            ...
            _push2(ssrRenderComponent(_component_CvInputTags, {
              ...
              "tag-list-label": `\u{1F9F8} ${_ctx.$t("interests")}`,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(formSettings).profileImageDataUri) {
        _push(`<img${ssrRenderAttrs(mergeProps({
          ...
          src: (_a = unref(formSettings).profileImageDataUri) != null ? _a : "",
...
//# sourceMappingURL=create-VVIuazP9.mjs.map
