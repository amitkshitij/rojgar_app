...
const CvPreviewTwoColumnStyles_HxLHemAL = [
  CvPreviewTwoColumn_vue_vue_type_style_index_0_scoped_c59ad454_lang
];

export { CvPreviewTwoColumnStyles_HxLHemAL as default };
//# sourceMappingURL=CvPreviewTwoColumn-styles.HxLHemAL.mjs.map
