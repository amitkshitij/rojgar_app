...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, getResponseStatus, createError, getRequestHost, getRequestProtocol, removeResponseHeader, getQuery as getQuery$1, readBody, setHeader, getHeader, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, getResponseStatusText } from 'file:///Users/amitsinha/Devzign/iOS%20Native/hyperhabits/hyper-habits-app/rojgar_app/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve as resolve$1, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/amitsinha/Devzign/iOS%20Native/hyperhabits/hyper-habits-app/rojgar_app/node_modules/@vue/shared/dist/shared.cjs.js';
import mysql from 'file:///Users/amitsinha/Devzign/iOS%20Native/hyperhabits/hyper-habits-app/rojgar_app/node_modules/mysql2/promise.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/amitsinha/Devzign/iOS%20Native/hyperhabits/hyper-habits-app/rojgar_app/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import process$1 from 'node:process';
import { renderToString } from 'file:///Users/amitsinha/Devzign/iOS%20Native/hyperhabits/hyper-habits-app/rojgar_app/node_modules/vue/server-renderer/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/amitsinha/Devzign/iOS%20Native/hyperhabits/hyper-habits-app/rojgar_app/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/amitsinha/Devzign/iOS%20Native/hyperhabits/hyper-habits-app/rojgar_app/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/amitsinha/Devzign/iOS%20Native/hyperhabits/hyper-habits-app/rojgar_app/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/amitsinha/Devzign/iOS%20Native/hyperhabits/hyper-habits-app/rojgar_app/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/amitsinha/Devzign/iOS%20Native/hyperhabits/hyper-habits-app/rojgar_app/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/amitsinha/Devzign/iOS%20Native/hyperhabits/hyper-habits-app/rojgar_app/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///Users/amitsinha/Devzign/iOS%20Native/hyperhabits/hyper-habits-app/rojgar_app/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/amitsinha/Devzign/iOS%20Native/hyperhabits/hyper-habits-app/rojgar_app/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///Users/amitsinha/Devzign/iOS%20Native/hyperhabits/hyper-habits-app/rojgar_app/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/amitsinha/Devzign/iOS%20Native/hyperhabits/hyper-habits-app/rojgar_app/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/amitsinha/Devzign/iOS%20Native/hyperhabits/hyper-habits-app/rojgar_app/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/amitsinha/Devzign/iOS%20Native/hyperhabits/hyper-habits-app/rojgar_app/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/amitsinha/Devzign/iOS%20Native/hyperhabits/hyper-habits-app/rojgar_app/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/amitsinha/Devzign/iOS%20Native/hyperhabits/hyper-habits-app/rojgar_app/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/amitsinha/Devzign/iOS%20Native/hyperhabits/hyper-habits-app/rojgar_app/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/amitsinha/Devzign/iOS%20Native/hyperhabits/hyper-habits-app/rojgar_app/node_modules/nitropack/node_modules/source-map/source-map.js';
import { toValue, isVNode, isRef } from 'file:///Users/amitsinha/Devzign/iOS%20Native/hyperhabits/hyper-habits-app/rojgar_app/node_modules/vue/index.mjs';
import devalue from 'file:///Users/amitsinha/Devzign/iOS%20Native/hyperhabits/hyper-habits-app/rojgar_app/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/amitsinha/Devzign/iOS%20Native/hyperhabits/hyper-habits-app/rojgar_app/node_modules/@nuxt/nitro-server/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/amitsinha/Devzign/iOS%20Native/hyperhabits/hyper-habits-app/rojgar_app/node_modules/errx/dist/index.js';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$2, isAbsolute } from 'file:///Users/amitsinha/Devzign/iOS%20Native/hyperhabits/hyper-habits-app/rojgar_app/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/amitsinha/Devzign/iOS%20Native/hyperhabits/hyper-habits-app/rojgar_app/node_modules/unhead/dist/server.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/amitsinha/Devzign/iOS%20Native/hyperhabits/hyper-habits-app/rojgar_app/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///Users/amitsinha/Devzign/iOS%20Native/hyperhabits/hyper-habits-app/rojgar_app/node_modules/unhead/dist/utils.mjs';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Users/amitsinha/Devzign/iOS%20Native/hyperhabits/hyper-habits-app/rojgar_app/node_modules/ipx/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/amitsinha/Devzign/iOS Native/hyperhabits/hyper-habits-app/rojgar_app/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/amitsinha/Devzign/iOS Native/hyperhabits/hyper-habits-app/rojgar_app","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/amitsinha/Devzign/iOS Native/hyperhabits/hyper-habits-app/rojgar_app/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/amitsinha/Devzign/iOS Native/hyperhabits/hyper-habits-app/rojgar_app/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/amitsinha/Devzign/iOS Native/hyperhabits/hyper-habits-app/rojgar_app/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/amitsinha/Devzign/iOS Native/hyperhabits/hyper-habits-app/rojgar_app/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "cvDatabaseHost": "93.127.194.37",
  "cvDatabasePort": 3306,
  "cvDatabaseName": "kisvps_mix_rozgar",
  "cvDatabaseUser": "mixdbuser",
  "cvDatabasePassword": "Q!W@E",
  "sitemap": {
    "isI18nMapped": true,
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Users/amitsinha/Devzign/iOS Native/hyperhabits/hyper-habits-app/rojgar_app/public"
      ]
    },
    "http": {
      "domains": []
...
let pool = null;
async function getCvStoragePool() {
  if (pool) {
    return pool;
  }
  const config = useRuntimeConfig();
  if (!config.cvDatabaseHost || !config.cvDatabaseName || !config.cvDatabaseUser || !config.cvDatabasePassword) {
    throw createError({
      statusCode: 500,
...
const _WdEJQhrV089ffkS0B2jp54mNQhqT1CIFjpYCJbd3KrA = defineNitroPlugin(async (nitroApp) => {
...
const rootDir = "/Users/amitsinha/Devzign/iOS Native/hyperhabits/hyper-habits-app/rojgar_app";

const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"google-site-verification","content":"CGbgWpLEg4fyBPWujKEYS3rrwZR4mMU7XfsDEGArchg"}],"link":[],"style":[],"script":[],"noscript":[]};
...
const _F4ag5jm51NzbyaA_W9EDV21Qh6kTkOjBL7_b0ApHnU = (nitroApp) => {
...
const plugins = [
  _WdEJQhrV089ffkS0B2jp54mNQhqT1CIFjpYCJbd3KrA,
_F4ag5jm51NzbyaA_W9EDV21Qh6kTkOjBL7_b0ApHnU
];
...
const _oojsu5 = eventHandler((event) => {
...
const getServerEntry = () => import('file:///Users/amitsinha/Devzign/iOS%20Native/hyperhabits/hyper-habits-app/rojgar_app/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///Users/amitsinha/Devzign/iOS%20Native/hyperhabits/hyper-habits-app/rojgar_app/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _WMuUuG = defineEventHandler(async (e) => {
...
const _HDqZtJ = defineEventHandler(async (e) => {
  const siteConfig = useSiteConfig(e);
  const nitroOrigin = useNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _y0uGGJ = defineEventHandler(async (e) => {
...
const _PAEFzb = defineEventHandler(async (e) => {
...
const _E2ZyIL = defineEventHandler(async (e) => {
...
const _83thaA = defineEventHandler(async (e) => {
...
const _QnPQrK = defineEventHandler(async (e) => {
  const runtimeConfig = useSimpleSitemapRuntimeConfig();
  const { sitemaps } = runtimeConfig;
...
const _0Zhgmb = lazyEventHandler(() => {
...
const _lazy_VQ7dtd = () => Promise.resolve().then(function () { return cv_get$1; });
const _lazy_hRClxO = () => Promise.resolve().then(function () { return cv_put$1; });
const _lazy_ht6X_t = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _oojsu5, lazy: false, middleware: true, method: undefined },
  { route: '/api/cv', handler: _lazy_VQ7dtd, lazy: true, middleware: false, method: "get" },
  { route: '/api/cv', handler: _lazy_hRClxO, lazy: true, middleware: false, method: "put" },
  { route: '/__nuxt_error', handler: _lazy_ht6X_t, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _WMuUuG, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _HDqZtJ, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap_index.xml', handler: _y0uGGJ, lazy: false, middleware: false, method: undefined },
  { route: '/en-sitemap.xml', handler: _PAEFzb, lazy: false, middleware: false, method: undefined },
  { route: '/es-sitemap.xml', handler: _PAEFzb, lazy: false, middleware: false, method: undefined },
  { route: '/id-sitemap.xml', handler: _PAEFzb, lazy: false, middleware: false, method: undefined },
  { route: '/de-sitemap.xml', handler: _PAEFzb, lazy: false, middleware: false, method: undefined },
  { route: '/fr-sitemap.xml', handler: _PAEFzb, lazy: false, middleware: false, method: undefined },
  { route: '/ar-sitemap.xml', handler: _PAEFzb, lazy: false, middleware: false, method: undefined },
  { route: '/zh-sitemap.xml', handler: _PAEFzb, lazy: false, middleware: false, method: undefined },
  { route: '/pt-sitemap.xml', handler: _PAEFzb, lazy: false, middleware: false, method: undefined },
  { route: '/az-sitemap.xml', handler: _PAEFzb, lazy: false, middleware: false, method: undefined },
  { route: '/nl-sitemap.xml', handler: _PAEFzb, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _E2ZyIL, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _83thaA, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _QnPQrK, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _0Zhgmb, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_ht6X_t, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_ht6X_t, lazy: true, middleware: false, method: undefined }
];
...
const cv_get$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: cv_get
}, Symbol.toStringTag, { value: 'Module' }));
...
const cv_put$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: cv_put
}, Symbol.toStringTag, { value: 'Module' }));
